...
import {
  setEmptyFolderMessage,
  folderSelector,
} from "../../features/fileFolder/fileFolderSlice";
...
const SubBar = ({ setSearchTerm }) => {
  ...
  //display creating folder Message

  useEffect(() => {
    if (folderMessage) {
      createToast(folderMessage, "success");
      dispatch(setEmptyFolderMessage());
    }
  }, [folderMessage, dispatch]);
